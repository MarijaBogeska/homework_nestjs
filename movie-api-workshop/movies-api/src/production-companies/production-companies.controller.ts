...
export class ProductionCompaniesController {
  ...
  @Patch(':id')
  update(@Param('id') id: string, @Body() updateProductionCompanyDto: UpdateProductionCompanyDto) {
    return this.productionCompaniesService.update(+id, updateProductionCompanyDto);
  }
